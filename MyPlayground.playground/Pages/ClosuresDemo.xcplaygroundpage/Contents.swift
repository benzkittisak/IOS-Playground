...
// ทีนี้เรามาลองใช้กับชีวิตจริงกันบ้าง คืออิแค่คูณเลข 2 ตัวมันไม่จำเป็นต้องใช้ฟังก์ชันอะนะ
var array = [6,4,8,1,2,8]

// เราจะเอาเลขทุกตัวใน array มา + 1 แหละโดยที่เราจะใช้ func map เหมือน map ใน js นั่นแหละ
print(array.map({ (number) in number + 1}))
